    ...
    <div class="modal inmodal" id="editSite{{ $site->id }}" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content animated fadeIn">
                ...
                <form name="site_form" id="site_form" action="{{ url(" sites/$site->id") }}" method="POST"> {{ method_field('PATCH') }}
                    <div class="modal-body">
                        {{ csrf_field() }}
                        <div class="form-group">
                            <label>Name</label>
    ...
    <div class="modal inmodal" id="editZone{{ $zone->id }}" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content animated fadeIn">
                ...
                <form name="site_form" id="site_form" action="{{ url(" zones/$zone->id") }}" method="POST"> {{ method_field('PATCH') }}
                    <div class="modal-body">
                        {{ csrf_field() }}
                        <div class="form-group">
                            <label>Name</label>
